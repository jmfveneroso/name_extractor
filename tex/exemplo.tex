...
handling tabular data, as it is most common on web data extraction tasks. For example, in 
narrative text we could learn patterns such as "X spoke to Y" and then discover from 
...
of tokens. Instead we rely on a priori probabilities and structural HTML features to attribute 
