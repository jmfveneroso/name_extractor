...
token independence. We also rely as little as possible on contextual information because in
the web extraction task it is frequently missing, noisy or inadequate.
...
that the previous token is a name. By taking this assumption, we get:
...
49 different countries with 11,782 researcher names. These names are the target of our 
